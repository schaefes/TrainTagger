...
""" baseline model using masking instead of 'is filled' feature, not yet supported in hls4ml
    and not prunable with the current setup, but should be considered for future studies"""
